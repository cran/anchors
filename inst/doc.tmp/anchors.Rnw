...
\hlink{\url{http://www.r-project.org}}{http://www.r-project.org},
...
\hlink{\url{http://www.r-project.org}}{http://www.r-project.org}.  Use at least \R\ \RVer.
For details on installing \R\ the FAQ at
\hlink{\url{http://cran.r-project.org/faqs.html}}{http://cran.r-project.org/faqs.html}
are helpful.
...
\begin{enumerate}
  \item downloading the source code from the anchors website:
    \hlink{anchors\_\AnchorsVer.tar.gz}{http://wand.stanford.edu/anchors/R/CRAN/src/contrib/anchorsR_\AnchorsVer.tar.gz}.
  \item
...
vo1<-anchors(~vign2+vign3+vign4+vign5+vign6, freedom, method="order")
